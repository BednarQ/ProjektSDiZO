	...
	while (isRunning) {		//główny
		...
		while (stan == state::S_TAB) {
			...
			cout << "\n\nMenu glowne programu dla operacji na tablicy.\n"
					...
					"2 - Dodaj element na poczatek tablicy\n"
					"3 - Dodaj element na koniec tablicy\n"
					"4 - Dodaj element w dowolnym miejscu tablicy\n"
					"5 - Usun element z tablicy\n"
					"6 - Znajdz element w tablicy\n"
					"7 - Wyswietl cala strukture\n"
			...
			case 1:
				...
				break;
			case 2:
				cout<<"Wprowadz wartosc elementu do dodania na poczatek"<<endl;
				cin>> element;
				tablica.dodajElementPoczatek(element);
				break;
			case 3:
				cout<<"Wprowadz wartosc elementu do dodania na koniec"<<endl;
				cin>> element;
				tablica.dodajElementKoniec(element);
				break;
			case 4:
				cout<<"Wprowadz wartosc elementu do dodania w losowym miejscu"<<endl;
				cin>> element;
				tablica.dodajElementLosowo(element);
				break;
			case 5:
